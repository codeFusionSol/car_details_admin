  ...
  return (
    <div className="container mx-auto p-6">
      <section className="bg-white rounded-lg shadow-lg p-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">Tyres Inspection</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Tyre Brand Checks */}
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="text-lg font-semibold mb-4">Tyre Brand Verification</h3>
                ...
                <div key={item} className="flex items-center space-x-3">
                  <input
                    ...
                    onChange={(e) => {
                      setFormData((prev) => {
                        const newData = { ...prev };
                        const checks = [...(newData.tyres.tyres.booleanChecks || [])];
                        const existingIndex = checks.findIndex(
                          (check) => check.name === item
                        );
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="text-lg font-semibold mb-4">Tyre Condition Images</h3>
